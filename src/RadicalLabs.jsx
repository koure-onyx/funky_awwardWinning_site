...
function ContactModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 bg-[#131313] border-4 border-white shadow-[12px_12px_0px_0px_#2E31FF] max-w-lg w-full p-10">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-white font-black text-2xl hover:text-[#2ff801] transition-colors"
        >
          ✕
        </button>
        {sent ? (
...
// ── Main Component ─────────────────────────────────────────────────────────────
export default function RadicalLabs() {
